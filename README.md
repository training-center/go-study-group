Repositório do grupo de estudos sobre Go do [Training Center](https://training-center.github.io).
...
Este grupo se destina ao estudo de Go.
...
Entrar no [Slack do Training Center](https://github.com/training-center/slack) e entrar no canal **#go-studies**.
